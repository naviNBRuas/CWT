...
if [ "${PLATFORM}" == "Windows" ]; then
    ...
    echo "    git clone https://github.com/your-github-username/CWT.git"
    echo "    cd CWT"
    ...
    echo "    (Note: The 'run.sh' script is for Linux/macOS. Windows users should execute Docker commands directly.)"
    ...
    echo "    (Alternatively, run the PyInstaller-generated executable from the 'dist' folder, e.g., 'dist/cwt.exe')"
